...
const searchStateToURL = (searchState) => {
  const routeState = {
    ...
    eventType:
      ...
      searchState.refinementList["node.eventType"],
    region:
      searchState.refinementList && searchState.refinementList["node.region"],
    audience:
      searchState.refinementList && searchState.refinementList["node.audience"],
    month:
      searchState.refinementList && searchState.refinementList["node.month"],
  };
...
const urlToSearchState = (location) => {
  ...
  if (Object.keys(filterList).length) {
    searchState.refinementList = filterList;
  }
